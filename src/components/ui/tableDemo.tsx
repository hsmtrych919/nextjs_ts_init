      ...
      <div className="table__responsive scroll-hint">
        <table className="table-spec">
          <tbody>
            ...
            <tr>
              <td rowSpan={3} className="font-medium">Ⅰ</td>
              <td rowSpan={3}>1,500</td>
              <td className="font-medium">20</td>
              <td>2,000</td>
              <td rowSpan={3} className="font-medium">6</td>
            ...
            <tr>
              <td rowSpan={3} className="font-medium">Ⅱ</td>
              <td rowSpan={3}>1,750</td>
              <td className="font-medium">20</td>
              <td>2,000</td>
              <td rowSpan={6} className="font-medium">6<br />9<br />11</td>
            ...
            <tr>
              <td rowSpan={3} className="font-medium">Ⅲ</td>
